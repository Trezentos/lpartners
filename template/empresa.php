...
?>
	...
	<div class="wrap waypoint animation_bottom">
		<div class="breadcrumb">
			<a href="<?php echo HTTP; ?>" title="Home"><?=$_lang[$lang]['inicial'];?></a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="<?php echo HTTP; ?>empresa/"><?php echo $_lang[$lang]['menu_empresa']; ?></a>
		</div>
		<br>
	</div>
...
<div class="columns waypoint animation_bottom"> </div> 
	...
	<section class="parceiros">
		<div class="wrap">
			...
			<div class="cycle-slideshow" data-cycle-fx="carousel" data-cycle-timeout="3000" data-cycle-slides="> div" data-cycle-carousel-visible="4" data-cycle-carousel-fluid="true">

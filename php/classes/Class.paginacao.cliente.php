...
class Paginator{
	...
	function paginate($pag=false)
	{
		...
		if($this->num_pages > 1)
		{
			$this->return = ($this->current_page != 1) ? "<span class=\"anterior\"><a class=\"paginate\" href=\"$this->link?page=$prev_page&ipp=$this->items_per_page$this->querystring\">Anterior</a></span> ":"<span class=\"anterior inactive\" href=\"#\">Anterior</span>";
			...
			for($i=1;$i<=$this->num_pages;$i++)
			{
				...
				{
					$this->return .= ($i == $this->current_page And $_GET['page'] != 'Todos') ? "<li class=\"active\"><a title=\"Go to page $i of $this->num_pages\" href=\"#\">$i</a></li> ":"<li><a class=\"paginate\" title=\"Go to page $i of $this->num_pages\" href=\"$this->link?page=$i&ipp=$this->items_per_page$this->querystring\">$i</a></li> ";
				}
			...
			$this->return .= (($this->current_page != $this->num_pages) And ($_GET['page'] != 'Todos')) ? "<span class=\"proxima\"><a class=\"paginate\" href=\"$this->link?page=$next_page&ipp=$this->items_per_page$this->querystring\">Próxima</a></span>\n":"<span class=\"proxima inactive\" href=\"#\">Próxima</span>\n";
		}
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)

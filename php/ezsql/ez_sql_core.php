	...
	class ezSQLcore
	{
		...
		*/
		...
		function debug($print_to_screen=true)
		{
			...
			echo "<blockquote style='margin: 20px 0 0 70px'>";
			...
			if ( $this->last_error )
			{
				echo "<font face=arial size=2 color=0000ee><b>Last Error --</b> [<font><b>$this->last_error</b></font>]<p>";
			}

			if ( $this->from_disk_cache )
			{
				echo "<font face=arial size=2 color=0000ee><b>Results retrieved from disk cache</b></font><p>";
			}

			echo "<font face=arial size=2><b>Query</b> [$this->num_queries] <b>--</b> ";
			echo "[<font><b>$this->last_query</b></font>]</font><p>";

				echo "<font face=arial size=2 color=0000ee><b>Query Result..</b></font>";
				echo "<blockquote>";
